...
protected:
    ...
    // // ////////////// backgraound multiplication factors obtained from AND logic in the background fitting using exclusive topology data /////////
    float background_fact[15][9] = {{6.31, 5.35, 4.50, 3.55, 2.42, 2.25, 1.93, 1.05, 1.25},
                                    {5.94, 5.12, 3.70, 3.65, 2.87, 1.75, 1.91, 1.43, 1.00},
                                    {6.89, 5.45, 4.07, 3.43, 2.38, 2.29, 1.68, 1.27, 1.00},
                                    {5.83, 4.90, 4.39, 3.65, 2.41, 2.04, 1.84, 1.09, 1.00},
                                    {5.16, 4.74, 4.28, 3.61, 2.59, 2.17, 1.71, 1.31, 1.57},
                                    {4.59, 4.03, 3.89, 3.23, 2.93, 3.15, 2.12, 2.11, 1.25},
                                    {4.23, 3.91, 3.75, 3.54, 3.29, 2.83, 3.18, 2.21, 1.33},
                                    {4.12, 3.84, 3.71, 3.57, 3.24, 3.41, 2.94, 2.72, 1.59},
                                    {3.80, 3.67, 3.53, 3.35, 3.26, 3.23, 3.22, 2.58, 1.62},
                                    {3.70, 3.56, 3.33, 3.32, 3.33, 3.17, 3.07, 3.10, 2.33},
                                    {3.75, 3.54, 3.37, 3.25, 3.38, 3.24, 3.18, 3.06, 1.76},
                                    {3.81, 3.49, 3.40, 3.28, 3.22, 3.25, 3.43, 3.28, 1.57},
                                    {3.76, 3.57, 3.52, 3.43, 3.17, 3.27, 3.67, 3.47, 1.40},
                                    {3.81, 3.67, 3.47, 3.41, 3.51, 3.39, 3.71, 3.16, 1.25},
                                    {3.71, 3.62, 3.42, 3.44, 3.29, 3.44, 3.73, 3.42, 1.00}};

    float background_tight[15][9] = {{6.03, 5.28, 4.16, 3.59, 2.76, 2.34, 2.16, 1.08, 1.25},
                                     {6.44, 5.19, 3.99, 3.93, 3.18, 2.02, 1.88, 1.67, 2.00},
                                     {5.71, 5.51, 4.07, 3.46, 2.65, 2.34, 1.86, 1.37, 1.50},
                                     {5.56, 4.50, 4.48, 3.16, 2.43, 2.52, 1.96, 1.84, 1.00},
                                     {4.80, 4.60, 4.05, 3.66, 3.04, 2.54, 2.09, 1.65, 1.68},
                                     {4.42, 4.46, 3.87, 3.93, 3.50, 3.57, 2.78, 2.06, 1.48},
                                     {4.42, 4.10, 3.94, 3.76, 3.52, 3.24, 3.04, 2.61, 1.91},
                                     {4.40, 3.90, 3.82, 3.67, 3.42, 3.59, 3.38, 3.06, 1.89},
                                     {3.97, 3.88, 3.72, 3.51, 3.55, 3.54, 3.59, 3.02, 1.74},
                                     {3.93, 3.77, 3.56, 3.51, 3.58, 3.35, 3.16, 3.25, 2.47},
                                     {3.89, 3.76, 3.58, 3.43, 3.54, 3.53, 3.38, 3.23, 1.74},
                                     {4.01, 3.68, 3.63, 3.50, 3.39, 3.39, 3.66, 3.39, 1.57},
                                     {3.97, 3.73, 3.69, 3.57, 3.38, 3.47, 3.65, 3.60, 1.00},
                                     {3.99, 3.83, 3.66, 3.57, 3.67, 3.57, 3.89, 3.49, 1.25},
                                     {3.84, 3.76, 3.60, 3.61, 3.52, 3.59, 3.82, 3.63, 1.00}};

    float background_loose[15][9] = {{7.22, 4.85, 3.84, 3.32, 2.58, 2.53, 2.60, 1.00, 1.00},
                                     {5.75, 5.82, 3.22, 3.19, 2.78, 1.78, 1.33, 1.33, 1.00},
                                     {6.43, 6.11, 3.61, 4.70, 2.32, 2.14, 1.44, 1.17, 1.00},
                                     {5.32, 4.74, 3.79, 3.61, 3.28, 1.77, 2.12, 1.00, 1.00},
                                     {6.02, 4.61, 4.50, 4.14, 2.43, 2.07, 1.31, 1.25, 2.00},
                                     {5.68, 4.91, 3.83, 3.03, 2.63, 3.02, 1.55, 1.57, 1.50},
                                     {4.30, 4.14, 3.56, 3.27, 2.65, 2.87, 2.56, 1.88, 1.00},
                                     {3.89, 3.59, 3.28, 3.19, 3.06, 3.62, 2.59, 3.17, 1.46},
                                     {3.74, 3.48, 3.51, 3.01, 3.04, 3.30, 3.10, 2.74, 1.15},
                                     {3.44, 3.37, 3.33, 3.14, 2.97, 2.90, 3.18, 2.95, 1.50},
                                     {3.57, 3.36, 3.27, 3.13, 3.11, 2.91, 2.75, 2.81, 1.82},
                                     {3.68, 3.37, 3.24, 3.21, 3.21, 3.03, 3.26, 3.24, 1.50},
                                     {3.56, 3.45, 3.37, 3.20, 2.93, 3.11, 3.65, 3.23, 1.33},
                                     {3.78, 3.56, 3.33, 3.23, 3.49, 3.40, 3.39, 3.01, 1.00},
                                     {3.58, 3.53, 3.28, 3.32, 3.17, 3.55, 3.71, 3.42, 1.00}};
